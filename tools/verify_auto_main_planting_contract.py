...
def main() -> int:
    ...
    require(action, "def _go_up_four", "AUTO PRO goUp(4) layer positioning missing")
    require(action, "GO_UP_START = (387, 69)", "goUp(4) start changed")
    require(action, "GO_UP_END = (387, 918)", "goUp(4) end changed")
