...
def main() -> int:
    ...
    # The first tuple entry remains Function 1 so existing operator behavior does
    # not silently switch to the unverified Function 2 after a normal rebuild.
    ...
    print("restart=same-profile+skip-duplicate-initial-sale")
    return 0
