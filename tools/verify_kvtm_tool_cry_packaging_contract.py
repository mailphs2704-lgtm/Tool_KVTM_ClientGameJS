...
def main() -> int:
    ...
    require(launch, '$updateRc = Invoke-CryBootstrapChild -Script $UpdateScript', "Updater is not run as isolated child")
    require(launch, '$runtimeRc = Invoke-CryBootstrapChild -Script $RuntimeScript', "Runtime bootstrap is not run as isolated child")
