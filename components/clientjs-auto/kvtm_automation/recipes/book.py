...
from .dried_tea_step_six import DriedTeaStepSixRecipe
...
class RecipeBook:
    ...
    def __init__(
        ...
        *,
        ...
        self.dried_tea_step_six: DriedTeaStepSixRecipe | None = None
        if self.function_id == "function_3":
            ...
            self.dried_tea_step_six = DriedTeaStepSixRecipe(
                automation,
                recovery=self.recovery,
            )
