...
FILE_FUNCTIONS = (
    ...
    "Ghi log hành động dễ đọc",
    "Ghi log nhận diện và kỹ thuật chi tiết",
...
class MainLogWriter:
    """Thread-safe action/detail logs for one profile and one run."""
    ...
    def action(self, message: str) -> None:
        self._write(self.action_path, message)
